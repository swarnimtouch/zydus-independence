...
<head>
  ...
  <link rel="preload" as="image" href="{{ asset('images/atorva_tab_portrait.png') }}" media="(min-width: 768px) and (max-width: 1368px) and (orientation: portrait)" />
  <link rel="preload" as="image" href="{{ asset('images/atorva_tab_bg.png') }}" media="(min-width: 700px) and (max-width: 1368px) and (orientation: landscape)" />
...
<body class="atorva-page">
  ...
  <main class="atorva-slide">
    <picture class="atorva-picture">
      <source media="(min-width: 768px) and (max-width: 1368px) and (orientation: portrait)" srcset="{{ asset('images/atorva_tab_portrait.png') }}" />
      <source media="(min-width: 700px) and (max-width: 1368px) and (orientation: landscape)" srcset="{{ asset('images/atorva_tab_bg.png') }}" />
